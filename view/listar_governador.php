  ...
  <div class="col-md-12">
    <table class="table table-bordered">
      ...
      <tbody>
        <?php
        try {
            $stmt = $conexao->prepare("SELECT * FROM candidato, partido, tipoCandidato WHERE candidato.partido = partido.idPartido AND candidato.tipoCandidato = tipoCandidato.idTipoCandidato AND tipoCandidato.idTipoCandidato = '4'");
            if ($stmt->execute()) {
