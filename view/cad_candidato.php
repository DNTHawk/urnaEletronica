    ...
    <form style="margin-top: 30px" action="?act=save" method="POST" enctype="multipart/form-data">
      ...
      <div class="col-md-2">
		...
		<div id="div_depultado_estadual">
			<?php 
				include("listar_depultadoEstadual.php");
			?>
		</div>
		<div id="div_depultado_federal">
			<?php 
				include("listar_depultadoFederal.php");
			?>
		</div>
		<div id="div_senador">
			<?php 
				include("listar_senador.php");
			?>
		</div>
		<div id="div_governador">
			<?php 
				include("listar_governador.php");
			?>
		</div>
		<div id="div_presidente">
			<?php 
		include("listar_presidente.php");
		?>
		</div>
  </div>
